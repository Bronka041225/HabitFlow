...
public final class HabitDao_Impl implements HabitDao {
  ...
  public HabitDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfHabitEntity = new EntityInsertionAdapter<HabitEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `habits` (`id`,`name`,`dailyTarget`,`unit`,`colorHex`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(3, entity.getDailyTarget());
      ...
      public List<HabitEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new HabitEntity(_tmpId,_tmpName,_tmpDailyTarget,_tmpUnit,_tmpColorHex,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<HabitEntity> getHabitById(final long id) {
      ...
      public HabitEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new HabitEntity(_tmpId,_tmpName,_tmpDailyTarget,_tmpUnit,_tmpColorHex,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
